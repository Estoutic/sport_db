...
CREATE USER client PASSWORD 'user_password';
CREATE USER trainer PASSWORD 'trainer_password';

GRANT admin_role TO admin;
GRANT user_role TO client;
GRANT trainer_role TO trainer;

-- Грант привилегий
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE diet_profiles TO trainer_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE diet_profiles TO admin_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE training_programs TO trainer_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE training_programs TO admin_role;
